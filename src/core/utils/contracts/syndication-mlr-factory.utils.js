...
import syndicationFactoryABI from "@/core/config/abi/syndication-mlr-factory";
import {
  BSC_TESTNET_SYNDICATION_MLR_FACTORY_CONTRACT_ADDRESS,
  NULL_ADDRESS,
...
export const createSyndicationMlr = async (data, vaultAddress, initAmount) => {
