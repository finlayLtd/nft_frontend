...
import syndicationABI from "@/core/config/abi/syndication-market";
...
export const addLiquidityMarket = (contractAddress, vaultAddress, value) => {
...
export const withdrawMarket = (contractAddress, lp) => {
  const contract = syndicationContract(contractAddress);
  return new Promise((resolve, reject) => {
    contract.methods
      .withdraw(lp)
