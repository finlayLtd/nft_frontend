...
<template>
  <body-container>
    <div class="text-2xl text-center text-white font-press pt-10 pb-3.5">
      Ledger
    </div>
    ...
    <div class="text-left font-ibm text-xs">
      <nftmx-table class="border border-black bg-tertiary-800">
        <nftmx-thead>
          <nftmx-tr>
        ...
        <nftmx-tbody>
          ...
          >
            ...
            <nftmx-td>{{ item.protectionRate || "-" }}</nftmx-td>
            <nftmx-td>
              <div
