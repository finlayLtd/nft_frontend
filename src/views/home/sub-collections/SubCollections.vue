...
<template>
  <div :class="[ledgerPanelVisible ? 'lg:pl-2' : 'pl-0', 'flex-1']">
    <div>
            ...
            >
              <nftmx-thead>
                ...
                <nftmx-tr class="border border-black text-left bg-tertiary-800">
                  ...
                  <th class="px-4 py-2">7D volume</th>
                ...
                >
                  ...
                  <nftmx-td>
                    <div class="flex gap-4.5 items-center">
                      <div class="w-11 h-11">
                        <nftmx-img
                          :src="contract.originNft.imageUrl"
                  ...
                  <nftmx-td
                    :class="[
                      contract.stats && contract.stats.volume1d >= 0
                        ? 'text-primary-900'
                        : 'text-red-900',
                    ]"
                  >
                    {{
                      contract.stats ? roundTo(contract.stats.volume1d, 2) : 0
                    }}%
                  </nftmx-td>
                  <nftmx-td
                    :class="[
                      contract.stats && contract.stats.volume1w >= 0
                        ? 'text-primary-900'
                        : 'text-red-900',
                    ]"
                  >
                    {{
                      contract.stats ? roundTo(contract.stats.volume1w, 2) : 0
                    }}%
                  </nftmx-td>
                  <nftmx-td
                    :class="[
