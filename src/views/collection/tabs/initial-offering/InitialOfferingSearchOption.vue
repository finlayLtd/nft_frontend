    ...
    >
      <div class="flex flex-1 w-full min-w-max items-center">
        <div class="w-full flex justify-between items-center gap-4 h-13">
          ...
          />
          <div class="relative h-8 w-64 border-r border-tertiary-700">
            <div
              :class="[
              ...
              >
                ...
                <div class="text-sm bg-tertiary-800">
                  ...
                  <div
                    ...
                    "
                    class="flex gap-1 font-ibm px-5 py-1 text-white transition hover:text-primary-900 cursor-pointer"
                  >
          ...
          <div
            ...
            :class="[
              ...
              'flex transition cursor-pointer text-lg',
            ]"
          >
