    ...
    <div v-if="true">
      ...
      <accordion bIcon :border="false" :sidebar="true" class="text-white mt-9">
        ...
        <div class="mt-6">
          ...
          >
            <div v-for="asset in offerings" :key="asset.id">
              <offering-card
                :asset="asset"
                :draggable="true"
      ...
      <accordion bIcon :border="false" :sidebar="true" class="text-white mt-3">
        ...
        <div class="mt-6">
          ...
          >
            <div v-for="asset in comingOfferings" :key="asset.id">
              <offering-card
                :asset="asset"
                :draggable="true"
                @dragstart="startDrag($event, asset)"
      ...
      <accordion bIcon :border="false" :sidebar="true" class="text-white mt-3">
        ...
        <div class="mt-6">
          ...
          >
            <div v-for="asset in pastOfferings" :key="asset.id">
              <offering-card
                :asset="asset"
                :draggable="true"
                @dragstart="startDrag($event, asset)"
