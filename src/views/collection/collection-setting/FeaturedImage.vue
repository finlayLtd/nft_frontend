  ...
  <setting-item-row class="mt-10 grid-cols-2 xl:grid-cols-3">
    <template v-slot:item>
      ...
      <div class="font-ibm text-tertiary-400 text-sm pt-2.5">
        ...
        category pages, or other promotional areas of nftmx. 600 x 400
        recommended.
      </div>
    </template>
    <template v-slot:value>
      <div class="md:grid md:grid-cols-8 text-tertiary-500 mt-4 xl:mt-0">
        <div class="col-span-5 md:pr-5">
          ...
          >
            <label
              for="featured-image-input"
              class="block relative overflow-hidden h-50 md:h-79"
            >
              <input
                type="file"
              ...
              <div>
                <div
                  :class="[
                    ...
                    'h-50 md:h-79 overlayed border-dash cursor-pointer',
                  ]"
                >
                  <div
        ...
        <div class="col-span-3 md:pl-6 mt-5 md:mt-0 w-full h-50 md:h-79">
          <div
