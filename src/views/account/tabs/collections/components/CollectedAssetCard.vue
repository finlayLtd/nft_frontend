  ...
  <div>
    <div class="w-full relative bg-tertiary-700">
      <div class="hover:shadow-primary-900 transition hover:shadow-default">
        <div
          class="bg-tertiary-400 relative w-full pt-65per overflow-hidden p-6 text-5xl"
        >
          <router-link
            :to="{
              name: 'asset',
        ...
        <div class="px-4.75 py-5.25">
          <div>
                  ...
                  >
                    <div
                      v-if="
                        ...
                        !token.mlrContract
                      "
                      class="transition text-secondary-700 cursor-pointer border-b border-tertiary-900 pb-2.25 mb-2"
                      @click="emit('open-derivative', token)"
                    >
                      Create derivatives
                    </div>
                    <router-link
            ...
            <div class="text-11 leading-4.5 text-white font-ibm">
              <div class="flex justify-between">
                ...
                <span class="text-primary-900">
                  {{
                    token.lastOrder
                      ? Math.round(token.lastOrder.protectionTime / 86400)
                      : 0
                  }}
                  Days
                </span>
              ...
              <div class="flex justify-between">
                ...
                <div class="flex items-center">
                  <span
                    :class="[
                      token.lastOrder && token.lastOrder.protectionRate < 100
                        ? 'text-primary-900'
                        : 'text-tertiary-400',
                    ]"
                  >
                    ...
                    {{
                      token.lastOrder
                        ? 100 - token.lastOrder.protectionRate
                        : 0
                    }}%
                  </span>
            ...
            <div
              class="h-14 text-tertiary-400 text-11 text-center relative mt-6"
            >
              <div>
