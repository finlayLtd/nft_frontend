...
import ChangeDueDateModal from "@/core/components/modal/ChangeDueDateModal.vue";
...
const openDueDateModal = () => {
  if (props.order.tokenPrice >= props.order.softCap) {
    toast.error("The soft cap has been reached.");
    return;
  }
        ...
        <div class="bg-tertiary-400 relative">
          ...
          >
            ...
            <div
              ...
              class="pt-13 pb-5 px-1 flex flex-col justify-around w-full h-full text-white font-ibm"
            >
            ...
            >
              ...
              <div class="text-center text-tertiary-400">Auction ended in</div>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      :class="[
                        order.tokenPrice >= order.softCap
                          ? 'text-tertiary-400 cursor-not-allowed'
                          : 'text-white hover:text-primary-900 cursor-pointer',
                        'transition',
                      ]"
                    >
                      Change due date
