...
const emit = defineEmits(["transfer", "hide", "vote", "remove-asset"]);
        ...
        <div class="px-4.75 py-5.25">
          <div>
            ...
            <div class="text-11 leading-4.5 text-white font-ibm">
              ...
              <div class="flex justify-between items-end">
                <div>
                  <span class="font-ibm-medium">Pending Offers</span>
                </div>
                <div class="text-primary-900">0</div>
              </div>
              <div class="flex justify-between items-end">
                <div class="flex">
                  <span class="font-ibm-medium">Top Bid</span>
                </div>
                <div class="flex items-center">
                  <span class="text-primary-900 flex items-center gap-1">
                    <font-awesome-icon
